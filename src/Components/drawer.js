    ...
    <div >
      ...
      <List >
        ...
        <div className="d-flex flex-row">
          ...
          <div className="p-2" style={{cursor:"pointer"}} >Profile</div>
        </div>
        </div>
      </List>
      <List>
        <div className='list mt-3' onClick={ () => { setComp("gametable") } }>
          <div className='d-flex flex-row'>
            ...
            <div className='p-2' style={{cursor:"pointer"}}>Games</div>
          </div>
        </div>
      </List>
      <List>
        <div className='list mt-3' onClick={()=> { setComp ("district")}}>
          <div className='d-flex flex-row'>
            ...
            <div className='p-2' style={{cursor:"pointer"}} >District</div>
          </div>
        </div>  
      </List>
      <List>
        <div className='list mt-3' onClick={()=> { setComp ("teacher")}}>
          <div className='d-flex flex-row'>
            ...
            <div className='p-2' style={{cursor:"pointer"}} >Teacher</div>
          </div>
        </div>
      </List>
      <List>
        <div className='list mt-3' onClick={()=> { setComp ("student")}}>
          <div className='d-flex flex-row'>
            ...
            <div className='p-2' style={{cursor:"pointer"}}>Student</div>
          </div>
        </div>
      </List> 
    </div>
